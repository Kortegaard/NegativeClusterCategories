...
describe('Testing Negative Cluster Category Functions', function () {
    test('Sigma', function () {
    ...
    test("N Cyclic Ordered", function () {
    ...
    test('Homomorphism Dimensions', function () {
